...
class Database {
    ...
    public function __construct() {
        ...
        $this->username = 'root'; // Ganti dengan username database
        $this->password = '202312035'; // Ganti dengan password database
        $this->database = 'petaniberdasi'; // Ganti dengan nama database
